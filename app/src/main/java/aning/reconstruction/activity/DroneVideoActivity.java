...
public class DroneVideoActivity extends Activity implements TextureView.SurfaceTextureListener, View.OnClickListener {
    private static final String TAG = DroneVideoActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.drone_video_activity);
            ...
            camera.setSystemStateCallback(new SystemState.Callback() {
                ...
                public void onUpdate(SystemState cameraSystemState) {
                    if (null != cameraSystemState) {
                        ...
                        DroneVideoActivity.this.runOnUiThread(new Runnable() {
    ...
    public void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(DroneVideoActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private boolean isMavicAir2(){
        BaseProduct baseProduct = FPVApplication.getProductInstance();
        if (baseProduct != null) {
